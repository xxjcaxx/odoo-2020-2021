...
class planet(models.Model):
    ...
    temperature_status = fields.Selection(
        [('1', 'frozen'), ('2', 'cold'), ('3', 'Good'), ('4', 'hot'), ('5', 'Too Hot')], default='3')
...
class building(models.Model):
    ...
    name = fields.Many2one('terraform.building_type', ondelete='restrict', required=True)
...
class construction(models.Model):
    ...
    name = fields.Char(compute='_get_name')
    planet = fields.Many2one('terraform.planet', ondelete='cascade', required=True)
    building_type = fields.Many2one('terraform.building_type', ondelete='cascade', required=True)
    time = fields.Float()
